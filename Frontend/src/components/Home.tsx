    ...
    return (
        <div>
            ...
            <div className="row">
                ...
                <div>
                    <ul className="b">
                        <li>Buid a form (on the EXAM page) to add new items to be listed in the <Link to="/example">example</Link> tab table</li>
                        <li>
                        ...
                        <li>Format date to be displayed in example table: 2016/01/20</li>
                            <li>Add search capability in <Link to="/example">example</Link> tab table. A single text field would be sufficient.</li>
                            <li>Replace "Load data" button with "next / previous" paging buttons. Display 30 items at a time</li>
                            <li><Link to="/example">Example</Link> tab should load first 30 automatically on first load</li>
                        </ul>
                    </div>
